...
public final class ItemTransactionBinding implements ViewBinding {
  ...
  private ItemTransactionBinding(@NonNull LinearLayout rootView, @NonNull TextView tvItemAmount,
  ...
  public static ItemTransactionBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemTransactionBinding((LinearLayout) rootView, tvItemAmount, tvItemDate,
          tvItemTitle);
    }
