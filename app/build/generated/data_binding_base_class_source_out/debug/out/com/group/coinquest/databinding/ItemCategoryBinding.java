...
public final class ItemCategoryBinding implements ViewBinding {
  ...
  private ItemCategoryBinding(@NonNull LinearLayout rootView, @NonNull Button btnDeleteCategory,
  ...
  public static ItemCategoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemCategoryBinding((LinearLayout) rootView, btnDeleteCategory, tvCategoryName);
    }
